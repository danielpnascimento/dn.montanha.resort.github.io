...
(function (global, factory) {
    ...
    var defaults = {
        ...
        // NS
        containerModifierClass: 'swiper-container-eventos-',
        // NEW
        slideClass: 'swiper-slide-eventos',
        slideBlankClass: 'swiper-slide-eventos-invisible-blank',
        slideActiveClass: 'swiper-slide-eventos-active',
        slideDuplicateActiveClass: 'swiper-slide-eventos-duplicate-active',
        slideVisibleClass: 'swiper-slide-eventos-visible',
        slideDuplicateClass: 'swiper-slide-eventos-duplicate',
        slideNextClass: 'swiper-slide-eventos-next',
        slideDuplicateNextClass: 'swiper-slide-eventos-duplicate-next',
        slidePrevClass: 'swiper-slide-eventos-prev',
        slideDuplicatePrevClass: 'swiper-slide-eventos-duplicate-prev',
        wrapperClass: 'swiper-wrapper-eventos',
        // Callbacks
    ...
    var Swiper = /*#__PURE__*/function () {
        ...
        _proto.emitContainerClasses = function emitContainerClasses() {
            ...
            var classes = swiper.el.className.split(' ').filter(function (className) {
                return className.indexOf('swiper-container-eventos') === 0 || className.indexOf(swiper.params.containerModifierClass) === 0;
            });
        ...
        _proto.getSlideClasses = function getSlideClasses(slideEl) {
            ...
            return slideEl.className.split(' ').filter(function (className) {
                return className.indexOf('swiper-slide-eventos') === 0 || className.indexOf(swiper.params.slideClass) === 0;
            }).join(' ');
        };
    ...
    var Thumbs$1 = {
        ...
        params: {
            thumbs: {
                ...
                autoScrollOffset: 0,
                slideThumbActiveClass: 'swiper-slide-eventos-thumb-active',
                thumbsContainerClass: 'swiper-container-eventos-thumbs'
            }
        },
        create: function create() {
            var swiper = this;
