...
(function (global, factory) {
    ...
    var defaults = {
        ...
        // NS
        containerModifierClass: 'swiper-container-valores-',
        // NEW
        slideClass: 'swiper-slide-valores',
        slideBlankClass: 'swiper-slide-valores-invisible-blank',
        slideActiveClass: 'swiper-slide-valores-active',
        slideDuplicateActiveClass: 'swiper-slide-valores-duplicate-active',
        slideVisibleClass: 'swiper-slide-valores-visible',
        slideDuplicateClass: 'swiper-slide-valores-duplicate',
        slideNextClass: 'swiper-slide-valores-next',
        slideDuplicateNextClass: 'swiper-slide-valores-duplicate-next',
        slidePrevClass: 'swiper-slide-valores-prev',
        slideDuplicatePrevClass: 'swiper-slide-valores-duplicate-prev',
        wrapperClass: 'swiper-wrapper-valores',
        // Callbacks
    ...
    var Swiper = /*#__PURE__*/function () {
        ...
        _proto.emitContainerClasses = function emitContainerClasses() {
            ...
            var classes = swiper.el.className.split(' ').filter(function (className) {
                return className.indexOf('swiper-container-valores') === 0 || className.indexOf(swiper.params.containerModifierClass) === 0;
            });
        ...
        _proto.getSlideClasses = function getSlideClasses(slideEl) {
            ...
            return slideEl.className.split(' ').filter(function (className) {
                return className.indexOf('swiper-slide-valores') === 0 || className.indexOf(swiper.params.slideClass) === 0;
            }).join(' ');
        };
    ...
    var Thumbs$1 = {
        ...
        params: {
            thumbs: {
                ...
                thumbsContainerClass: 'swiper-container-valores-thumbs'
            }
        },
        create: function create() {
            var swiper = this;
