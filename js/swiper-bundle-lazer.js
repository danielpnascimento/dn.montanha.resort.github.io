...
(function (global, factory) {
    ...
    var defaults = {
        ...
        // NEW
        slideClass: 'swiper-slide-lazer',
        slideBlankClass: 'swiper-slide-lazer-invisible-blank',
        slideActiveClass: 'swiper-slide-lazer-active',
        slideDuplicateActiveClass: 'swiper-slide-lazer-duplicate-active',
        slideVisibleClass: 'swiper-slide-lazer-visible',
        slideDuplicateClass: 'swiper-slide-lazer-duplicate',
        slideNextClass: 'swiper-slide-lazer-next',
        slideDuplicateNextClass: 'swiper-slide-lazer-duplicate-next',
        slidePrevClass: 'swiper-slide-prev-lazer',
        slideDuplicatePrevClass: 'swiper-slide-duplicate-prev-lazer',
        wrapperClass: 'swiper-wrapper-lazer',
        // Callbacks
    ...
    var Pagination$1 = {
        ...
        params: {
            pagination: {
                ...
                bulletClass: 'swiper-pagination-lazer-bullet',
                bulletActiveClass: 'swiper-pagination-lazer-bullet-active',
                modifierClass: 'swiper-pagination-lazer-',
                // NEW
                currentClass: 'swiper-pagination-lazer-current',
                totalClass: 'swiper-pagination-lazer-total',
                hiddenClass: 'swiper-pagination-lazer-hidden',
                progressbarFillClass: 'swiper-pagination-lazer-progressbar-fill',
                progressbarOppositeClass: 'swiper-pagination-lazer-progressbar-opposite',
                clickableClass: 'swiper-pagination-lazer-clickable',
                // NEW
                lockClass: 'swiper-pagination-lazer-lock'
            }
        },
        create: function create() {
            var swiper = this;
