...
(function (global, factory) {
    ...
    var defaults = {
        ...
        // NS
        containerModifierClass: 'swiper-container-suites-',
        // NEW
        slideClass: 'swiper-slide-suites',
        slideBlankClass: 'swiper-slide-suites-invisible-blank',
        slideActiveClass: 'swiper-slide-suites-active',
        slideDuplicateActiveClass: 'swiper-slide-suites-duplicate-active',
        slideVisibleClass: 'swiper-slide-suites-visible',
        slideDuplicateClass: 'swiper-slide-duplicate',
        slideNextClass: 'swiper-slide-suites-next',
        slideDuplicateNextClass: 'swiper-slide-suites-duplicate-next',
        slidePrevClass: 'swiper-slide-suites-prev',
        slideDuplicatePrevClass: 'swiper-slide-suites-duplicate-prev',
        wrapperClass: 'swiper-wrapper-suites',
        // Callbacks
    ...
    var Swiper = /*#__PURE__*/function () {
        ...
        _proto.emitContainerClasses = function emitContainerClasses() {
            ...
            var classes = swiper.el.className.split(' ').filter(function (className) {
                return className.indexOf('swiper-container-suites') === 0 || className.indexOf(swiper.params.containerModifierClass) === 0;
            });
        ...
        _proto.getSlideClasses = function getSlideClasses(slideEl) {
            ...
            return slideEl.className.split(' ').filter(function (className) {
                return className.indexOf('swiper-slide-suites') === 0 || className.indexOf(swiper.params.slideClass) === 0;
            }).join(' ');
        };
    ...
    var Thumbs$1 = {
        ...
        params: {
            thumbs: {
                ...
                thumbsContainerClass: 'swiper-container-suites-thumbs'
            }
        },
        create: function create() {
            var swiper = this;
